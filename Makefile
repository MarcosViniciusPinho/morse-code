...
build-linux:
	...
	GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build -ldflags="-s -w" -o out/linux/morse-code ./cmd/cli/main.go

build-windows:
	@echo "\n🔨 Building Windows executable..."
	GOOS=windows GOARCH=amd64 CGO_ENABLED=0 go build -ldflags="-s -w" -o out/windows/morse-code.exe ./cmd/cli/main.go

build-macos:
	@echo "\n🔨 Building macOS executable..."
	GOOS=darwin GOARCH=amd64 CGO_ENABLED=0 go build -ldflags="-s -w" -o out/macos/morse-code ./cmd/cli/main.go
